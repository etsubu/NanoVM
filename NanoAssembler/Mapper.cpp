...
int Mapper::mapImmediate(std::string value, std::vector<unsigned char>& bytes) {
	...
	try {
		if (value[0] == '-')
		{
			...
			if (value64 <= INT8_MAX) {
				bytes.push_back(static_cast<int8_t>(value64));
				return Byte;
			}
			else if (value64 <= INT16_MAX) {
				uint16_t value16 = static_cast<int16_t>(value64);
				bytes.push_back(static_cast<int8_t>(value16 >> 8));
				bytes.push_back(static_cast<int8_t>(value16));
				return Short;
			}
			else if (value64 <= INT32_MAX) {
				uint32_t value32 = static_cast<int32_t>(value64);
				bytes.push_back(static_cast<int8_t>(value32 >> 24));
				bytes.push_back(static_cast<int8_t>(value32 >> 16));
				bytes.push_back(static_cast<int8_t>(value32 >> 8));
				bytes.push_back(static_cast<int8_t>(value32));
				return Dword;
			}
			else {
				bytes.push_back(static_cast<int8_t>(value64 >> 56));
				bytes.push_back(static_cast<int8_t>(value64 >> 48));
				bytes.push_back(static_cast<int8_t>(value64 >> 40));
				bytes.push_back(static_cast<int8_t>(value64 >> 32));
				bytes.push_back(static_cast<int8_t>(value64 >> 24));
				bytes.push_back(static_cast<int8_t>(value64 >> 16));
				bytes.push_back(static_cast<int8_t>(value64 >> 8));
				bytes.push_back(static_cast<int8_t>(value64));
				return Qword;
			}
		}
